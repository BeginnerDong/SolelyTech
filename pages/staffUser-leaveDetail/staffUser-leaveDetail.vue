...
<style>
	...
	.editLine .item{border-bottom: 0;padding: 30rpx 0; align-items: flex-start!important;}
	.editLine .item .ll{width: 20%;}
	.editLine .item .rr{width: 80%;color: #666;font-size: 26rpx;}
